...
interface User { id: string; username: string; email: string; is_active: boolean }
...
export const UsersPage = () => {
  ...
  const createUser = async (event: React.FormEvent) => {
    ...
    try {
      ...
      setUsername(''); setEmail(''); setPassword(''); setShowForm(false); loadUsers()
