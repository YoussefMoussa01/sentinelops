...
class DeviceRepository:
    ...
    def create(db: Session, *, user_id: str | None, hostname: str, ip_address: str | None,
               ...
               status: str, last_seen=None, ip_address_id: str | None = None) -> Device:
        device = Device(user_id=user_id, ip_address_id=ip_address_id, hostname=hostname, ip_address=ip_address,
